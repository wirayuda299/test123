...
import { hostMeetup } from "@/public/images";
import { Button } from "../ui/button";

const HostMeetupCard = () => {
  return (
    <Card className="p-5 rounded-2xl relative bg-center bg-no-repeat bg-cover bg-meetUpBg">
      <CardHeader className="p-0">
        <CardTitle className="p-0 heading3 text-white mb-1">Host a Meetup</CardTitle>
